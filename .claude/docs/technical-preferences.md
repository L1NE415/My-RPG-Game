...
- **Touch Support**: None
- **Platform Notes**: No d-pad navigation required. Mouse hover interactions are allowed.
...
- **Events/Delegates**: PascalCase with `On` prefix or `EventHandler` suffix (e.g., `OnHealthChanged`)
- **Files**: PascalCase matching class (e.g., `PlayerController.cs`)
- **Scenes/Prefabs**: PascalCase (e.g., `BattleScene.unity`, `PlayerCharacter.prefab`)
...
- **Framework**: Unity Test Runner (NUnit / `[UnityTest]` attribute)
