...
**CRITICAL**: Your training data has a knowledge cutoff. Before suggesting Unity API code, you MUST:
...
4. Read `docs/engine-reference/unity/current-best-practices.md` for new Unity patterns
5. For subsystem-specific work, read the relevant `docs/engine-reference/unity/modules/*.md`

If a suggested API appears in `deprecated-apis.md`, use the listed replacement instead.
If uncertain whether an API exists in the pinned version, use WebSearch to verify before suggesting it.
