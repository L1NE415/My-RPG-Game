...
**CRITICAL**: Your training data has a knowledge cutoff. Before suggesting Unity Addressables code, you MUST:

1. Read `docs/engine-reference/unity/VERSION.md` to confirm the engine version
2. Check `docs/engine-reference/unity/deprecated-apis.md` for any Addressables APIs you plan to use
3. Check `docs/engine-reference/unity/breaking-changes.md` for asset management changes
4. Read `docs/engine-reference/unity/plugins/addressables.md` for current Addressables state
5. Read `docs/engine-reference/unity/current-best-practices.md` for new asset management patterns

Addressables workflow changed significantly between Unity 2021 and Unity 6. Always verify
async loading patterns and catalog APIs against the pinned version docs.
If uncertain whether an Addressables API exists in the pinned version, use WebSearch to verify.
