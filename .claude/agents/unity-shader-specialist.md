...
**CRITICAL**: Your training data has a knowledge cutoff. Before suggesting Unity shader or rendering code, you MUST:
...
3. Check `docs/engine-reference/unity/breaking-changes.md` for rendering-related changes
4. Read `docs/engine-reference/unity/modules/rendering.md` for current URP/HDRP state
5. Read `docs/engine-reference/unity/current-best-practices.md` for new rendering patterns

If a shader API or URP/HDRP feature appears in `deprecated-apis.md`, use the listed replacement.
If uncertain whether a Shader Graph node or HLSL intrinsic is supported, use WebSearch to verify.
